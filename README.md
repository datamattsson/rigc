...
🛑 **MacOS Seqoia 15.0 to 15.3.1 and potential future updates:** Local serial port open/close is super slow. This makes RigC unusable in local serial port mode during live production. Configuring the multiviewer as a one off with RigC is fine. Monitor this thread for updates: https://discussions.apple.com/thread/255763367
